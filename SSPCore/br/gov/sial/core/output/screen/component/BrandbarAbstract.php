 ...
 * @name BrandbarAbstract
 * */
abstract class BrandbarAbstract extends ComponentAbstract implements IBuild
{
    /**
     * Agregador do componente brandbar
     * @var string
     */
    protected $_brandbar;
    ...
    {
        $namespace = self::NSComponent('brandbar', $type);
