 ...
 * @name Json
 * */
class Json extends JsonAbstract implements IBuild
{
    /**
     * Construtor
     * @param Array $param
    ...
    {
        $this->_json = json_encode(array('count' => count($param->data), 'data'  => $param->data));
    }

    /**
     *
     * @return \br\gov\sial\core\output\screen\component\html\Json
     */
