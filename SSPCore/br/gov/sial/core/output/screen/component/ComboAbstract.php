 ...
 * @name ComboAbstract
 * */
abstract class ComboAbstract extends ComponentAbstract implements IBuild
{
    /**
    ...
    {
        $namespace = self::NSComponent('combo', $type);

        return new $namespace($config);
    }

    /**
     * @return ComboAbstract
     */
