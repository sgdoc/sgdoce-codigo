 ...
 * */
class SIALException extends Exception
{
    /**
     * Lança exception se o argumento for nulo.
     *
     ...
     * */
    public static function throwsExceptionIfParamIsNull ($avaliable, $message, $code = 0, Exception $previous = NULL)
    {
