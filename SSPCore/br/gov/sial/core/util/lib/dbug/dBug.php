<?php
namespace br\gov\sial\core\util\lib\dbug;
/*********************************************************************************************************************\
 * LAST UPDATE
 * ============
 * March 22, 2007
...
class dBug {
    ...
    function makeTableHeader($type,$header,$colspan=2) {
        ...
        echo "<table cellspacing=2 cellpadding=3 class=\"dBug_".$type."\">
                <tr>
                    <td nowrap ".$str_i."class=\"dBug_".$type."Header\" colspan=".$colspan." onClick='dBug_toggleTable(this)'>".$header."</td>
                </tr>";
    }
    ...
    function initJSandCSS() {
        echo <<<SCRIPTS
            ...
            <style type="text/css">
                ...
                /* object */
                table.dBug_object { background-color:#DFDECB; }
