...
require_once("odsFontFace.php");
require_once("odsStyle.php");
require_once("odsTable.php");
require_once("odsTableColumn.php");
require_once("odsTableRow.php");
require_once("odsTableCell.php");
...
class ods
{
    ...
    {
        if (in_array($odsFontFace, $this->fontFaces))
            return;
    ...
    {
        if (in_array($odsStyle, $this->styles))
            return;
    ...
    public function addTmpStyles (odsStyle $odsStyle)
    {
        if (in_array($odsStyle, $this->styles))
            return;
        if (in_array($odsStyle, $this->tmpStyles))
            return;
    ...
    public function getStyleByName ($name)
    {
        ...
        if (isset($this->tmpStyles[$name]))
            return $this->tmpStyles[$name];
        return null;
    }

    public function addTable (odsTable $odsTable)
    {
        if (in_array($odsTable, $this->tables))
            return;
