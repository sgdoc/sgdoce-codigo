...
use \br\gov\sial\core\persist\exception\PersistException,
    \br\gov\sial\core\persist\database\Config as ConfigParent;
 ...
 * */
class Config extends ConfigParent
{
    /**
     * @var string
     * */
    ...
    public function getDSN()
    {
        ...
        return "pgsql:host={$hostname};dbname={$database};port={$port}";
    }
    ...
    {
        $require = array('adapter', 'hostname', 'password','port', 'source', 'username');
