 ...
 * */
namespace br\gov\mainapp\application\libcorp\banco\mvcb\business;
...
/**
  ...
  * @version $Id$
  * */
class BancoBusiness extends ParentBusiness
{
    /**
    ...
    public function listAll ()
    {
        try {
            ...
            return $this->arrayObjectToCombo('noBanco', 'sqBanco', $result);
