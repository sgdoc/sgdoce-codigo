 ...
 * */
namespace br\gov\mainapp\application\libcorp\email\mvcb\model;
...
/**
  ...
  * @version $Id$
  * */
class EmailModel extends ParentModel
{
    /**
    ...
    {
        try {
            $this->_resultSet = $this->_persist->findByCpf($pessoaFisicaVO);
            return $this;
