 ...
 * @name libCorpUpdateCadastroSemCPF
...
$ICMBioWSservice->wsdl->addComplexType(
        ...
        'all',
        '',
        array('sqCadastroSemCPF' => array('name' => 'sqCadastroSemCPF' ,'type' => 'xsd:integer'  ),
...
$ICMBioWSservice->register(
        "libCorpUpdateCadastroSemCPF",
        array('updCadastroSemCPF' => 'tns:updCadastroSemCPF', 'userCredential' => 'tns:userCredential'),
        array('return'            => 'xsd:string'),
        $serviceUrl,
        FALSE,
        'rpc',
        'encoded',
        'Servi&ccedil;o respons&aacute;vel por efetuar atualizacao na tabela Cadastro Sem CPF'
);

function libCorpUpdateCadastroSemCPF($updCadastroSemCPF, $userCredential = NULL)
{
    ...
    try{
        ...
        $voCadastroSemCPF = CadastroSemCPFValueObject::factory()->loadData($updCadastroSemCPF);
        $voCadastroSemCPF = CadastroSemCPFBusiness::factory()->update($voCadastroSemCPF);
