...
$ICMBioWSservice->register(
        "libCorpUpdateAgencia",
        array('updAgencia' => 'tns:updAgencia', 'userCredential' => 'tns:userCredential'),
        array('return'     => 'xsd:string'),
        $serviceUrl,
        FALSE,
        'rpc',
        'encoded',
        'Servi&ccedil;o respons&aacute;vel por alterar Agencias'
);
