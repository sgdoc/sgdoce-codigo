...
$ICMBioWSservice->wsdl->addComplexType(
        ...
        array('sqMunicipio'       => array('name' => 'sqMunicipio'       ,'type' => 'xsd:integer'),
              ...
              'sqEndereco'        => array('name' => 'sqEndereco'        ,'type' => 'xsd:integer')
        )
);
...
$ICMBioWSservice->register(
        "libCorpDeleteEndereco",
        array('delEndereco' => 'tns:delEndereco', 'userCredential' => 'tns:userCredential'),
        array('return'      => 'xsd:string'),
        $serviceUrl,
        FALSE,
        'rpc',
        'encoded',
        'Servi&ccedil;o respons&aacute;vel por excluir Endereços'
);


function libCorpDeleteEndereco($delEndereco, $userCredential = NULL)
{
    ...
    try{
        ...
        $voEndereco = EnderecoValueObject::factory()->loadData($delEndereco);
        $voEndereco = EnderecoBusiness::factory()->deleteEndereco($voEndereco);
