...
$ICMBioWSservice->register(
        ...
        array('updEndereco' => 'tns:updEndereco', 'userCredential' => 'tns:userCredential'),
        array('return'      => 'xsd:string'),
        $serviceUrl,
        FALSE,
        'rpc',
        'encoded',
        'Servi&ccedil;o respons&aacute;vel por atualizar Endereços'
);

function libCorpUpdateEndereco($updEndereco, $userCredential = NULL)
{
    ...
    try{
        ...
        $voEndereco = EnderecoValueObject::factory()->loadData($updEndereco);
        $voEndereco = EnderecoBusiness::factory()->updateEndereco($voEndereco);
