 ...
 * @name libCorpDeletePessoaVinculo
...
$ICMBioWSservice->wsdl->addComplexType(
        ...
        array('sqPessoa'               => array('name' => 'sqPessoa'               ,'type' => 'xsd:integer'),
               ...
               'stRegistroAtivo'        => array('name' => 'stRegistroAtivo'        ,'type' => 'xsd:string'),
               'sqPessoaVinculo'        => array('name' => 'sqPessoaVinculo'        ,'type' => 'xsd:integer')
        )
);
...
$ICMBioWSservice->register(
        "libCorpDeletePessoaVinculo",
        array('delPessoaVinculo' => 'tns:delPessoaVinculo', 'userCredential' => 'tns:userCredential'),
        array('return'           => 'xsd:string'),
        $serviceUrl,
        FALSE,
        'rpc',
        'encoded',
        'Servi&ccedil;o respons&aacute;vel por excluir PessoaVinculo'
);

function libCorpDeletePessoaVinculo($delPessoaVinculo, $userCredential = NULL)
{
    ...
    try {
        ...
        $voPessoaVinculo = PessoaVinculoValueObject::factory()->loadData($delPessoaVinculo);
        $voPessoaVinculo = PessoaVinculoBusiness::factory()->deletePessoaVinculo($voPessoaVinculo);
