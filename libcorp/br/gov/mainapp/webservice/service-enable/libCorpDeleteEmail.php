...
$ICMBioWSservice->wsdl->addComplexType(
        ...
        array('txEmail'     => array('name' => 'txEmail'     ,'type' => 'xsd:string'),
              ...
              'sqEmail'     => array('name' => 'sqEmail'     ,'type' => 'xsd:integer')
        )
);
...
$ICMBioWSservice->register(
        "libCorpDeleteEmail",
        array('delEmail' => 'tns:delEmail', 'userCredential' => 'tns:userCredential'),
        array('return'   => 'xsd:string'),
        $serviceUrl,
        FALSE,
        'rpc',
        'encoded',
        'Servi&ccedil;o respons&aacute;vel por excluir Email'
);

function libCorpDeleteEmail($delEmail, $userCredential = NULL)
{
    ...
    try{
        ...
        $voEmail = EmailValueObject::factory()->loadData($delEmail);
        $voEmail = EmailBusiness::factory()->deleteEmail($voEmail);
