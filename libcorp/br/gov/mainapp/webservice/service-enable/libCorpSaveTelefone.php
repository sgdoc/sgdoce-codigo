...
$ICMBioWSservice->register(
        "libCorpSaveTelefone",
        array('telefone' => 'tns:telefone', 'userCredential' => 'tns:userCredential'),
        array('return'   => 'xsd:string'),
        $serviceUrl,
        FALSE,
        'rpc',
        'encoded',
        'Servi&ccedil;o respons&aacute;vel por cadastrar Telefone'
);

function libCorpSaveTelefone($telefone, $userCredential = NULL)
{
    ...
    try{
        ...
        $voTelefone = TelefoneValueObject::factory()->loadData($telefone);
        $voTelefone = TelefoneBusiness::factory()->save($voTelefone);
