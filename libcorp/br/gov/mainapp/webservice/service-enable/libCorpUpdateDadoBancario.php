 ...
 * @name libCorpUpdateDadoBancario
...
$ICMBioWSservice->wsdl->addComplexType(
    ...
    array('sqAgencia'          => array('name' => 'sqAgencia'          ,'type' => 'xsd:integer'),
          ...
          'sqDadoBancario'     => array('name' => 'sqDadoBancario'     ,'type' => 'xsd:string')
    )
);
...
$ICMBioWSservice->register(
        ...
        array('updDadoBancario' => 'tns:updDadoBancario', 'userCredential' => 'tns:userCredential'),
        array('return'          => 'xsd:string'),
        $serviceUrl,
        FALSE,
        'rpc',
        'encoded',
        'Servi&ccedil;o respons&aacute;vel por atualizar Dados Bancarios'
);
