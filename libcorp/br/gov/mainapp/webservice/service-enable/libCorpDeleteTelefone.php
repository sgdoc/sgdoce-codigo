...
$ICMBioWSservice->register(
        "libCorpDeleteTelefone",
        array('delTelefone' => 'tns:delTelefone', 'userCredential' => 'tns:userCredential'),
        array('return'      => 'xsd:string'),
        $serviceUrl,
        FALSE,
        'rpc',
        'encoded',
        'Servi&ccedil;o respons&aacute;vel por excluir Telefone'
);
