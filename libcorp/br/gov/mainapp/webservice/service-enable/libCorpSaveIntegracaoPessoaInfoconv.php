 ...
 * SISICMBio
 *
 * Módulo WebService - LIBCorp - IntegracaoPessoaInfoconvBusiness::save
 *
 * libCorpSaveIntegracaoPessoaInfoconv
 * 
 * @package br.gov.icmbio.webservice
 * @subpackage services-available
 * @name libCorpSaveIntegracaoPessoaInfoconv
 * @author Carlos Eduarodo <carloseduardophp@gmail.com>
 * @since 2015-05-07
 * @version $Id$
 */

use br\gov\mainapp\application\libcorp\integracaoPessoaInfoconv\mvcb\business\IntegracaoPessoaInfoconvBusiness,
...
$ICMBioWSservice->wsdl->addComplexType(
        ...
        array(
              ...
              'dtIntegracao'    => array('name' => 'dtIntegracao'    , 'type' => 'xsd:string' ),
...
$ICMBioWSservice->register(
        "libCorpSaveIntegracaoPessoaInfoconv",
        array('integracaoPessoaInfoconv'  => 'tns:integracaoPessoaInfoconv', 'userCredential' => 'tns:userCredential'),
        array('return' => 'xsd:string'),
        $serviceUrl,
        FALSE,
        'rpc',
        'encoded',
        'Servi&ccedil;o respons&aacute;vel por integrarPessoaInfoconv'
);
...
function libCorpSaveIntegracaoPessoaInfoconv($integracaoPessoaInfoconv, $userCredential = NULL)
{
    ...
    try{
        ...
        $voIntegracaoPI = IntegracaoPessoaInfoconvValueObject::factory()
                ->loadData( $integracaoPessoaInfoconv );
        
        $voIntegracaoPI = IntegracaoPessoaInfoconvBusiness::factory()
                ->save($voIntegracaoPI);

        return sprintf($xmlResult,
                        'success',
                        '00000',
                        $voIntegracaoPI->toXml()
                       );
