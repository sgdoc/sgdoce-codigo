 ...
 * SISICMBio
 *
 * Módulo WebService - LIBCorp - UnidadeOrgBusiness::findUndDescentralizadaByNome
 *
 * @package br.gov.icmbio.webservice
 * @subpackage services-available
 * @name libCorpUnidadeOrgByUndDescenNome
...
$ICMBioWSservice->register(
    "libCorpUnidadeOrgByUndDescenNome",
       ...
       FALSE,
       FALSE,
       'Efetua a busca em Unidades Descentralizadas por Nome Pessoa (PessoaValueObject::noPessoa)'
);
