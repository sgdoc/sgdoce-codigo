...
$ICMBioWSservice->register(
        ...
        array('addDadoBancario' => 'tns:addDadoBancario', 'userCredential' => 'tns:userCredential'),
        array('return'          => 'xsd:string'),
        $serviceUrl,
        FALSE,
        'rpc',
        'encoded',
        'Servi&ccedil;o respons&aacute;vel por cadastrar Dados Bancarios'
);

function libCorpSaveDadoBancario($addDadoBancario, $userCredential = NULL)
{
    ...
    try{
        ...
        $voDadoBancario = DadoBancarioValueObject::factory()->loadData($addDadoBancario);
        $voDadoBancario = DadoBancarioBusiness::factory()->saveDadoBancario($voDadoBancario);

        return sprintf($xmlResult,
                        'success',
                        '00000',
                        $voDadoBancario->toXml()
                       );
