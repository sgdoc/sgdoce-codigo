 ...
 * @name libCorpSaveVinculoSistemico
...
$ICMBioWSservice->register(
        "libCorpSaveVinculoSistemico",
        array('sVinculoSistemico' => 'tns:sVinculoSistemico', 'userCredential' => 'tns:userCredential'),
        array('return'            => 'xsd:string'),
        $serviceUrl,
        FALSE,
        'rpc',
        'encoded',
        'Servi&ccedil;o respons&aacute;vel por cadastrar VinculoSistemico'
);
