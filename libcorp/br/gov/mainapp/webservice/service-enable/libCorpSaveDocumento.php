 ...
 * SISICMBio
 *
 * Módulo WebService - LIBCorp - DocumentoBusiness::saveDocumento
 *
 * @package br.gov.icmbio.webservice
 * @subpackage services-available
 * @name libCorpSaveDocumento
...
$ICMBioWSservice->register(
        "libCorpSaveDocumento",
        array('documento' => 'tns:documento', 'userCredential' => 'tns:userCredential'),
        array('return'    => 'xsd:string'),
        $serviceUrl,
        FALSE,
        'rpc',
        'encoded',
        'Servi&ccedil;o respons&aacute;vel por cadastrar Documentos'
);

function libCorpSaveDocumento($documento, $userCredential = NULL)
{
    ...
    try{
        ...
        $voDocumento = DocumentoValueObject::factory()->loadData($documento);
        $voDocumento = DocumentoBusiness::factory()->saveDocumento($voDocumento);
