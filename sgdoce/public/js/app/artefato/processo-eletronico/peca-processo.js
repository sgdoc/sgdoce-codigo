var PecaProcesso = {
    VincularDocumentoAutoComplete : function() {
        $('#nuArtefatoVinculacaoPeca').simpleAutoComplete("/artefato/processo-eletronico/find-tipo-artefato/buscaPeca/1", {
    ...
    $(".btnConcluirPeca").click(function(){
    	if($('#form-peca-processo-modal').valid()) {
            ...
            Message.showConfirmation({
                'body': 'Deseja incluir a digital '+$('#nuDigital :selected').text()+' ao processo?',
