var ProcessoEletronico = {
    init: function(){
        ...
        $('.btn-concluir').click(function() {
            ...
            if( $("input[name*='dataInteressado']").length <= 0
                && $("#table-interessado tbody tr td:not(.dataTables_empty)").length <= 0 ) {
    ...
    sair: function( url ) {
        Message.showConfirmation({
            'body': "Tem certeza que deseja cancelar o cadastro?",
