 ...
 * @name         AnexoComprovanteController
 * @version      1.0.0
 * @since        2012-08-21
 */
class Auxiliar_AnexoComprovanteController extends \Core_Controller_Action_CrudDto
{
    protected $_messageCreate = 'MN013';
    protected $_messageEdit   = 'MN043';

    /** @var Principal\Service\Documento */
    protected $_service = 'AnexoComprovante';

    /** @var array */
    protected $_optionsDtoEntity = array(
        'entity' => 'Sgdoce\Model\Entity\AnexoComprovante',
    );
    ...
    public function deleteAction()
    {
        ...
        $this->getService()->deleteAnexoComprovante($dto);
