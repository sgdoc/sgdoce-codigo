 ...
 * @since        2012-08-21
 */
class Auxiliar_AnexoComprovanteDocumentoController extends \Core_Controller_Action_CrudDto
{
    protected $_messageCreate = 'MN013';
    protected $_messageEdit   = 'MN043';

    /** @var Principal\Service\Documento */
    protected $_service = 'AnexoComprovanteDocumento';

    /** @var array */
    protected $_optionsDtoEntity = array(
        'entity' => 'Sgdoce\Model\Entity\AnexoComprovanteDocumento',
    );
