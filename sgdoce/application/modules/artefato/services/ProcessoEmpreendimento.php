...
class ProcessoEmpreendimento extends \Core_ServiceLayer_Service_CrudDto
{
    /**
     * @var string
     */
    protected $_entityName = 'app:ProcessoEmpreendimento';

    public function findProcesso($dto)
    {
        $criteria = array('sqArtefato' => $dto->getSqArtefato()->getSqArtefato()
                ,'sqEmpreendimento' =>$dto->getSqEmpreendimento()->getCodigo());
