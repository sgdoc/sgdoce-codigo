...
/**
 * Sgdoce\Model\Entity\VwCaixaMinutaAcompanhamento
 *
 * @ORM\Table(name="vw_caixa_minuta_acompanhamento")
 * @ORM\Entity(repositoryClass="\Sgdoce\Model\Repository\Artefato", readOnly=true)
 */
class VwCaixaMinutaAcompanhamento extends \Core_Model_Entity_Abstract
{
    /**
    ...
    {
        $this->sqOcorrencia = $sqHistoricoArtefato;
    }
