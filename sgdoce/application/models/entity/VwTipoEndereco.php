...
/**
 * Sgdoce\Model\Entity\VwTipoEndereco
 *
 * @ORM\Table(name="vw_tipo_endereco")
 * @ORM\Entity(repositoryClass="Sgdoce\Model\Repository\VwTipoEndereco", readOnly=true)
 */
class VwTipoEndereco extends \Core_Model_Entity_Abstract
{
    /**
