...
/**
 * Sgdoce\Model\Entity\VwAtributoDocumento
 *
 * @ORM\Table(name="vw_atributo_documento")
 * @ORM\Entity(repositoryClass="Sgdoce\Model\Entity\VwAtributoDocumento", readOnly=true)
 */
class VwAtributoDocumento extends \Core_Model_Entity_Abstract
{
