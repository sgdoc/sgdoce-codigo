...
/**
 * Sgdoce\Model\Entity\SolicitacaoMigracaoImagem
 *
 * @ORM\Table(name="solicitacao_migracao_imagem")
 * @ORM\Entity(repositoryClass="Sgdoce\Model\Repository\SolicitacaoMigracaoImagem")
 * @OWM\Logger(eventLog="insert::update::delete")
 */
class SolicitacaoMigracaoImagem extends \Core_Model_Entity_Abstract
{

    /**
     * @var integer $sqSolicitacao
     *
     * @ORM\Column(name="sq_solicitacao_migracao_imagem", type="integer", nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="AUTO")
     */
    private $sqSolicitacaoMigracaoImagem;
     ...
     * @return integer
     */
    public function getSqSolicitacaoMigracaoImagem ()
    {
        return $this->sqSolicitacaoMigracaoImagem;
    }
    ...
    function setSqSolicitacaoMigracaoImagem ($sqSolicitacaoMigracaoImagem)
    {
        $this->sqSolicitacaoMigracaoImagem = $sqSolicitacaoMigracaoImagem;
        return $this;
    }
