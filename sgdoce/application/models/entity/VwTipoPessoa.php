...
/**
 * Sgdoce\Model\Entity\VwTipoPessoa
 *
 * @ORM\Table(name="vw_tipo_pessoa")
 * @ORM\Entity(repositoryClass="Sgdoce\Model\Repository\VwTipoPessoa", readOnly=true)
 */
class VwTipoPessoa extends \Core_Model_Entity_Abstract
{
