...
abstract class Core_Doc_Factory
{
    ...
    public static function create($docTemplate = null, array $docData = array(), $adapter = 'Pdf', $orientation = 'P')
    {
        ...
        return self::$docContents = self::getAdapter()->docGen($docTemplate, $docData, self::getFilePath(), $orientation);
    }
    ...
    public static function download($docTemplate = null, array $docData = array(), $fileName = null, $adapter = 'Pdf', $orientation='P')
    {
        self::setFileName($fileName);

        self::create($docTemplate, $docData, $adapter, $orientation);
