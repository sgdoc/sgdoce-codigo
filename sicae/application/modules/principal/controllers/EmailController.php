 ...
 * @since        2012-08-21
 */
class Principal_EmailController extends \Core_Controller_Action_CrudDto
{
    ...
    protected $_optionsDtoEntity = array(
        ...
        'mapping' => array(
            'sqTipoEmail' => '\Sica\Model\Entity\TipoEmail',
    ...
    public function init()
    {
        ...
        if ($this->_getParam('id')) {
            $cmb['sqTipoEmail'] = $this->getService('TipoEmail')->getComboDefault();
        } else {
            $cmb['sqTipoEmail'] = $this->getService('TipoEmail')->getComboForSqPessoa($sqPessoa);
        }
