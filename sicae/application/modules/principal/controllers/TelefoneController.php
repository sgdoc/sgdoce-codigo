 ...
 * @since        2012-08-21
 */
class Principal_TelefoneController extends \Core_Controller_Action_CrudDto
{

    /** @var Principal\Service\Telefone */
    protected $_service = 'Telefone';

    /** @var array */
    protected $_optionsDtoEntity = array(
        'entity' => '\Sica\Model\Entity\Telefone',
        'mapping' => array(
            'sqTipoTelefone' => '\Sica\Model\Entity\TipoTelefone',
