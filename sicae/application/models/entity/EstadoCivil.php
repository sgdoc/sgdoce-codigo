...
/**
 * Sica\Model\Entity\EstadoCivil
 *
 * @ORM\Table(name="vw_estado_civil")
 * @ORM\Entity(repositoryClass="Sica\Model\Repository\EstadoCivil", readOnly=true)
 */
class EstadoCivil extends \Core_Model_Entity_Abstract
{
