...
/**
 * Sica\Model\Entity\TipoTelefone
 *
 * @ORM\Table(name="vw_tipo_telefone")
 * @ORM\Entity(repositoryClass="Sica\Model\Repository\TipoTelefone", readOnly=true)
 */
class TipoTelefone extends \Core_Model_Entity_Abstract
{
    /**
