 ...
 * @version	 1.0.0
 */
class TipoDocumento extends \Sica_Model_Repository
{
    ...
    public function getComboForSqPessoa($sqPessoa = NULL)
    {
        ...
        $result = $this->_em
                ...
                ->from('app:TipoDocumento', 'tp')
        		->innerJoin('tp.sqAtributoTipoDocumento', 'atd');

        if ($criteria) {
            $result->andWhere($this->_em->createQueryBuilder()->expr()->notIn('tp.sqTipoDocumento', $criteria));
        }
