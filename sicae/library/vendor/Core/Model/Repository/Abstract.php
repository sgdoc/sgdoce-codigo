...
abstract class Core_Model_Repository_Abstract extends Doctrine\ORM\EntityRepository
{
    ...
    protected function _fetchPagination ($params, $queryBuilder)
    {
        ...
        return $this->$method($params, $queryBuilder);
    }
    ...
    public function searchPage($method, $params)
    {
        $queryBuilder = $this->{$method}($params);

        $result = $this->_fetchPagination($params, $queryBuilder);
    ...
    public function searchPageDto($method, \Core_Dto_Search $dto)
    {
