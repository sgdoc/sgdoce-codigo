...
class Core_Translate_Message extends Zend_Translate_Adapter
{
    ...
    public function __construct($options = array())
    {
        ...
        if (isset($options['startToken'])) {
            $this->setStartToken($options['startToken']);
        }

        if (isset($options['endToken'])) {
            $this->setEndToken($options['endToken']);
        }
    }
    ...
    public function setStartToken($token)
    {
    ...
    public function setEndToken($token)
    {
        $this->endToken = $token;
        return $this;
    }
