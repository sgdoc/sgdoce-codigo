 ...
 * @package    Core
 * @subpackage Validate
 * @see https://github.com/ramonornela/Zebra/blob/master/library/Zebra/Validate/Cnpj.php
 */
class Core_Validate_Cnpj extends Zend_Validate_Abstract
{
    ...
    * @return Core_Validate_Cpf provides a fluent interface
    ...
    */
    public function setSeparatorMode($mode)
    {
        ...
        if ($detected <= 0 || $detected > self::FORMAT_AUTO) {
            throw new Core_Validate_Exception('Modo desconhecido');
        }
    ...
    * @return Core_Validate_Cnpj provides a fluent interface
    * @throws Core_Validate_Exception
    */
    public function setService($service)
    {
        if (!is_callable($service)) {
            throw new Core_Validate_Exception('Callback inválido');
        }
