...
/**
 ...
 1.0.4 (unreleased)
 - Abilityhttp://dev.sisicmbio.icmbio.gov.br/sica/index/captchaShow to output audible codes in mp3 format to stream from flash
...
class Securimage {
    ...
    */
     ...
     * @var string
     */
    var $audio_path = '/media/sisicmbio/sica/audio/';
